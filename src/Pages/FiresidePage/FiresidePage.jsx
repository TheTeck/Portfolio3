...
import './FiresidePage.scss';

export default function FiresidePage (props) {

    const [activeSection, setActiveSection] = useState('des');

    const links = {
        site: "https://fireside-connect.herokuapp.com/",
        github: "https://github.com/TheTeck/Fireside"
    }

    const tech = ['HTML', 'SCSS', 'Javascript', 'React', 'Node', 'Express', 'MongoDB', 'Mongoose'];
    ...
    return (
        <div className="firesidepage-container">
            <Banner main="Fireside" />
            <ContentContainer>
